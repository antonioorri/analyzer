...
public class Main {
    public static void main(String[] args) {
        ...
        int ok = 0;
    for (String className : new String[]{"Constant","EuclideanDistance","LinearSearchConstant","MatrixMultiplicationConstant"}) { // uncomment this line and comment the next one to test a single algorithm
